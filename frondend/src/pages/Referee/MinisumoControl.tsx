...
interface MinisumoControlProps {
  match: MatchState;
...
export const MinisumoControl = ({
  ...
  onControl,
  formatTime,
}: MinisumoControlProps) => {
  const [showMoreActions, setShowMoreActions] = useState(false);

  // Specific Minisumo timers
  ...
  const getRoundPosition = (round: number) => {
    switch (round) {
      case 1:
        return {
          text: "ESPALDAS",
          desc: "Robots de espaldas en el borde del Dohyo.",
        };
      case 2:
        return {
          text: "DE LADO",
          desc: "Robots paralelos entre sí en la línea de inicio.",
        };
      case 3:
        return {
          text: "FRENTE A FRENTE",
          desc: "Robots frente a frente en líneas de inicio.",
        };
      default:
        return { text: "FINALIZADO", desc: "Encuentro concluido." };
    }
  };

  const pos = getRoundPosition(currentRound);
